...
function ModalDeleteFinanceiro({ id, refresh }: props) {
  ...
  const remove = async () => {
    try {
      if (!id) throw new Error("Erro ao remover o gasto!");
      const { status } = await deleteDespesaTabela(id);
...
export default ModalDeleteFinanceiro;
