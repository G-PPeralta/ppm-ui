...
// DESCRIÇÃO DO ARQUIVO: COMPONENTE PADRONIZADO PARA BOTÃO COM VISUAL MAIS LARGO NA COR AZUL COM VARIANT OUTLINE
...
function BotaoAzulLargoOutline({
  text,
  leftIcon,
  rightIcon,
  formikForm,
...
export default BotaoAzulLargoOutline;
